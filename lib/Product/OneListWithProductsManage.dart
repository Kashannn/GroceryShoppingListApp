...
class OneListWithProductsManage extends StatefulWidget {
  const OneListWithProductsManage({Key? key}) : super(key: key);

  @override
  State<OneListWithProductsManage> createState() =>
      _OneListWithProductsManageState();
}

class _OneListWithProductsManageState extends State<OneListWithProductsManage> {
  @override
